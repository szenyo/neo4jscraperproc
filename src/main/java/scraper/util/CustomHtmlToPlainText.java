...
/**
 * Customized by Janos Szendi-Varga on 2019. 09. 04.
 * Removing retrieval of Href strings from org.jsoup.examples.HtmlToPlainText
 */
public class CustomHtmlToPlainText {
    ...
    private class FormattingVisitor implements NodeVisitor {
        ...
        private void append(String text) {
            ...
            // from formats above, not in natural text
            if (text.equals(" ") &&
                    (accum.length() == 0 || StringUtil.in(accum.substring
                            (accum.length() - 1), " ", "\n")))
